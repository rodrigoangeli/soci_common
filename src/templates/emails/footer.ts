export const footer = `<tr class="ultimoPaiInner">
        ...
        <tbody>
                                ...
                                <td style="background-color: #EDF0F2; vertical-align: top" width="100%" align="center">
                                    <table style="max-width:480px;" width="100%" align="center">
                                        <tbody>
                                            <tr>
                                                <td height="60"></td>
                                                <td width="15%" align="center"><a rel="nofollow" target="_blank" href="https://www.instagram.com/socializo_/"><img alt="Instagram" src="https://d2ipbo5js8nd63.cloudfront.net/instagram.png" style="border:none;" title="Instagram" width="32" /></a></td>
                                                <td height="60"></td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <tr>
                <td align="center" style="background-color: #EDF0F2; color: #666666; font-family: Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px; padding: 0px 30px 30px 30px">
                    <p style="margin: 0;text-align: center"><a href="" target="_blank" style="color: #111111; font-weight: 600;">usesocializo.com</a></p>
                </td>
            </tr>
            <tr>
                <td align="center" style="background-color: #EDF0F2; color: #666666; font-family: Helvetica, Arial, sans-serif; font-size: 12px; font-weight: 400; line-height: 18px; padding: 0px 30px 30px 30px">
                    <div style="margin: 5px 0; text-align: center"></div>Copyright @ 2023 - socializo.
                </td>
            </tr>
        </tbody>
    </table>
